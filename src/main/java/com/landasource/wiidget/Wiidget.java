...
public abstract class Wiidget {
    ...
    protected <W extends Wiidget> W wiidget(final Class<W> widgetClass, final Map<String, Object> dataMap) {
    ...
    protected <W extends Wiidget> W endWiidget(final W wiidget) {
        ...
        final Wiidget closedWiidget = endWiidget();
    ...
    /**
     * Start the buffer. The content and result of childen will be collected in
     * a new buffer which is stacked upon the previous buffers.
     */
