...
public interface Engine {
    ...
    /**
     * @param owner       owner of the wiidget
     * @param widgetClass type of the wiidget
     * @param attributes  attribute map to set
     * @param putToStack  should put to stack
     * @param <W>         type of the wiidget
     * @return the new constructed wiidget with set properties
     */
    public <W extends Wiidget> W createWiidget(Wiidget owner, Class<W> widgetClass, Map<String, Object> attributes, boolean putToStack);
    ...
    /**
     * @param componentClass creates instance from class
     * @param <W>            type of wiidget
     ...
     *
     * @param componentClass class of wiidget
     * @param data           data to set
     * @param <C>            type of wiidget
     * @return instance
     */
     ...
     *
     * @param wiidget    wiidget to add
     * @param owner      the owner
     * @param putToStack should put to wiidget stack?
     */
    public void addWiidget(final Wiidget wiidget, final Wiidget owner, final boolean putToStack);
